...
router.get('/', function (req, res) {
  ...
  _product["default"].find(function (err, docs) {
    ...
    if (!req.user) {
      return res.render('shop/allproducts', {
        title: 'Shopping cart',
...
router.get('/add-to-cart/:id', function (req, res) {
  ...
  var cart = new _cart["default"](req.session.cart ? req.session.cart : {});
  ...
  _product["default"].findById(productId, function (err, product) {
    ...
    req.session.cart = cart; // z(req.session.cart);
...
router.get('/shoppingcart', function (req, res) {
  ...
  if (!req.user) {
    var cart = new _cart["default"](req.session.cart);
    return res.render('shop/shoppingcart', {
